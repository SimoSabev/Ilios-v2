        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-12">
          ...
          <div className="lg:col-span-4">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold text-neutral-900 mb-4">ILIOS DECOR</h3>
              <p className="text-neutral-600 mb-6 leading-relaxed">
                Luxury yacht interior and exterior design services. Creating sophisticated maritime spaces with premium
                materials and timeless elegance for discerning yacht owners worldwide.
              </p>

              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3 text-neutral-600">
                  <Mail size={16} />
                  <span className="text-sm">info@iliosdecor.com</span>
                </div>
                <div className="flex items-center gap-3 text-neutral-600">
                  <Phone size={16} />
                  <span className="text-sm">+33 (0) 4 93 12 34 56</span>
                </div>
                <div className="flex items-center gap-3 text-neutral-600">
                  <MapPin size={16} />
                  <span className="text-sm">Monaco & French Riviera</span>
                </div>
              </div>
