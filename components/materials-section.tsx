        ...
        {materials.map((material) => (
          ...
          >
            <Image
              ...
              alt={`${material.name} yacht interior scene`}
              fill
          ...
          <Reveal>
            <div>
              ...
              <p className="text-lg text-white/90 leading-relaxed max-w-2xl">
                Every yacht design begins with the finest marine-grade materials, carefully selected for their beauty,
                durability, and ability to withstand the demanding maritime environment while maintaining luxury
                aesthetics.
              </p>
            </div>
          </Reveal>
